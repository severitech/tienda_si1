...
<body class="pt-[80px] bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col mt-15 mb-15">

   <!-- Header fijo al top -->
<header class="fixed top-0 left-0 right-0 z-50 bg-white/90 dark:bg-[#121212]/90 backdrop-blur-md shadow-md border-b border-gray-200 dark:border-gray-800">
            ...
            <nav class="flex items-center justify-end gap-4">
                ...
                @guest
                    ...
                    @if (Route::has('register'))
                        <flux:button variant="filled" class="px-4 py-2"><a href="{{ route('register') }}">Registrarse</a></flux:button>
                    @endif
                @endguest
            </nav>
        @endif
