<div class="relative w-full mx-auto mb-3">
    ...
    {{-- Autocompletado --}}
    @if (strlen($search) > 0 && $usuarios->count() > 0)
        <ul
            ...
            @forelse ($usuarios as $usuario)
                <li wire:click="guardarUsuario({{ $usuario->id }})"
                    ...
                    <br>
                    <span class="text-gray-500 dark:text-gray-400"> Teléfono: {{ $usuario->telefono }}</span>
                </li>
            @empty
