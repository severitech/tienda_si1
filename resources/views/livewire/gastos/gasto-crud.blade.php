<div class="p-4 relative overflow-x-auto rounded-lg dark:bg-zinc-900">
    ...
    <div class="flex flex-col gap-3 pb-4 md:flex-row md:items-center md:justify-between">
        <div class="flex items-start gap-2">
            <flux:modal.trigger name="crear">
                <button wire:click="limpiar"
                    class="bg-green-600 text-white px-4 py-2 rounded-xl shadow hover:bg-green-500">
                    Nuevo Gasto
                </button>
            </flux:modal.trigger>
        </div>
        ...
        <div class="relative">
            <input wire:model="search"
                class="rounded-xl w-[400px] p-2.5 text-sm bg-zinc-50 border border-zinc-300 text-zinc-900 placeholder-zinc-500 focus:ring-blue-500 focus:border-blue-500 dark:bg-zinc-800 dark:border-zinc-600 dark:text-white dark:placeholder-zinc-400"
