                    ...
                    <td class="px-6 py-4">
                        <div class="flex space-x-2">
                            ...
                            <button
                                ...
                                class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-red-600 text-white shadow-md hover:bg-red-700 active:scale-95 active:shadow-inner focus:outline-none focus:ring-2 focus:ring-red-400 transition-all duration-150"
                                title="Eliminar"
                            >
