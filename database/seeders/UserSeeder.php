...
class UserSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('GASTOS')->insert([
            ...
            ['DESCRIPCION' => 'Compra de suministros', 'MONTO' => 120.00, 'CANTIDAD' => 3, 'USUARIO' => 1, 'METODO_PAGO' => 'QR', 'created_at' => now()->subDays(6), 'CAJA' => 5], // 6 días atrás
            ['DESCRIPCION' => 'Pago de servicios', 'MONTO' => 150.00, 'CANTIDAD' => 1, 'USUARIO' => 1, 'METODO_PAGO' => 'Tarjeta', 'created_at' => now()->subDays(5), 'CAJA' => 3], // 5 días atrás
            ['DESCRIPCION' => 'Compra de equipo', 'MONTO' => 80.00, 'CANTIDAD' => 2, 'USUARIO' => 1, 'METODO_PAGO' => 'Efectivo', 'created_at' => now()->subDays(4), 'CAJA' => 1], // 4 días atrás
            ...
            ['DESCRIPCION' => 'Pago de software', 'MONTO' => 110.00, 'CANTIDAD' => 3, 'USUARIO' => 3, 'METODO_PAGO' => 'Transferencia Bancaria', 'created_at' => now()->addDays(4), 'CAJA' => 5], // 4 días futuros
            ['DESCRIPCION' => 'Pago de suscripción mensual', 'MONTO' => 115.00, 'CANTIDAD' => 1, 'USUARIO' => 3, 'METODO_PAGO' => 'Stripe', 'created_at' => now()->addDays(5), 'CAJA' => 4], // 5 días futuros

            // Usuario 4 (No tiene Tarjeta ni Stripe)
            ['DESCRIPCION' => 'Compra de suministros de oficina', 'MONTO' => 90.00, 'CANTIDAD' => 5, 'USUARIO' => 4, 'METODO_PAGO' => 'QR', 'created_at' => now()->addDays(6), 'CAJA' => 3], // 6 días futuros
            ['DESCRIPCION' => 'Pago de servicios de internet', 'MONTO' => 85.00, 'CANTIDAD' => 1, 'USUARIO' => 4, 'METODO_PAGO' => 'Efectivo', 'created_at' => now()->addDays(7), 'CAJA' => 2], // 7 días futuros
            ['DESCRIPCION' => 'Compra de material', 'MONTO' => 95.00, 'CANTIDAD' => 10, 'USUARIO' => 4, 'METODO_PAGO' => 'Transferencia Bancaria', 'created_at' => now()->addDays(8), 'CAJA' => 4],
             // 8 días futuros

            // Usuario 5 (No tiene QR ni Stripe)
            ['DESCRIPCION' => 'Compra de cámaras de seguridad', 'MONTO' => 150.00, 'CANTIDAD' => 2, 'USUARIO' => 5, 'METODO_PAGO' => 'Tarjeta', 'created_at' => now()->addDays(9), 'CAJA' => 1], // 9 días futuros
            ['DESCRIPCION' => 'Pago de gastos operativos', 'MONTO' => 100.00, 'CANTIDAD' => 1, 'USUARIO' => 5, 'METODO_PAGO' => 'Efectivo', 'created_at' => now()->addDays(10), 'CAJA' => 1], // 10 días futuros
            ['DESCRIPCION' => 'Compra de software de contabilidad', 'MONTO' => 120.00, 'CANTIDAD' => 1, 'USUARIO' => 5, 'METODO_PAGO' => 'Transferencia Bancaria', 'created_at' => now()->addDays(11), 'CAJA' => 3], // 11 días futuros

            // Usuario 6 (No tiene Transferencia Bancaria ni Stripe)
            ['DESCRIPCION' => 'Compra de equipos para oficina', 'MONTO' => 110.00, 'CANTIDAD' => 2, 'USUARIO' => 6, 'METODO_PAGO' => 'QR', 'created_at' => now()->addDays(12), 'CAJA' => 4], // 12 días futuros
            ['DESCRIPCION' => 'Pago de servicios de mantenimiento', 'MONTO' => 130.00, 'CANTIDAD' => 3, 'USUARIO' => 6, 'METODO_PAGO' => 'Tarjeta', 'created_at' => now()->addDays(13), 'CAJA' => 3], // 13 días futuros
            ['DESCRIPCION' => 'Compra de muebles de oficina', 'MONTO' => 125.00, 'CANTIDAD' => 4, 'USUARIO' => 6, 'METODO_PAGO' => 'Efectivo', 'created_at' => now()->addDays(14), 'CAJA' => 4], // 14 días futuros

            // Usuario 7 (Solo tiene QR y Transferencia Bancaria)
            ['DESCRIPCION' => 'Pago de insumos de oficina', 'MONTO' => 90.00, 'CANTIDAD' => 6, 'USUARIO' => 7, 'METODO_PAGO' => 'QR', 'created_at' => now()->addDays(15), 'CAJA' => 3], // 15 días futuros
            ['DESCRIPCION' => 'Compra de equipos electrónicos', 'MONTO' => 160.00, 'CANTIDAD' => 3, 'USUARIO' => 7, 'METODO_PAGO' => 'Transferencia Bancaria', 'created_at' => now()->addDays(16), 'CAJA' => 5], // 16 días futuros

            // Usuario 8 (Solo tiene Efectivo y Transferencia Bancaria)
            ['DESCRIPCION' => 'Compra de material de oficina', 'MONTO' => 75.00, 'CANTIDAD' => 10, 'USUARIO' => 8, 'METODO_PAGO' => 'Efectivo', 'created_at' => now()->addDays(17), 'CAJA' => 5], // 17 días futuros
            ['DESCRIPCION' => 'Pago de suscripción mensual', 'MONTO' => 80.00, 'CANTIDAD' => 1, 'USUARIO' => 8, 'METODO_PAGO' => 'Transferencia Bancaria', 'created_at' => now()->addDays(18), 'CAJA' => 4], // 18 días futuros

            // Usuario 9 (No tiene QR ni Tarjeta)
            ['DESCRIPCION' => 'Pago de servicios de telecomunicaciones', 'MONTO' => 60.00, 'CANTIDAD' => 1, 'USUARIO' => 9, 'METODO_PAGO' => 'Efectivo', 'created_at' => now()->addDays(19), 'CAJA' => 3], // 19 días futuros
            ['DESCRIPCION' => 'Compra de equipos de trabajo', 'MONTO' => 95.00, 'CANTIDAD' => 2, 'USUARIO' => 9, 'METODO_PAGO' => 'Transferencia Bancaria', 'created_at' => now()->addDays(20), 'CAJA' => 3], // 20 días futuros
            ['DESCRIPCION' => 'Pago de software de gestión', 'MONTO' => 110.00, 'CANTIDAD' => 1, 'USUARIO' => 9, 'METODO_PAGO' => 'Stripe', 'created_at' => now()->addDays(21), 'CAJA' => 2], // 21 días futuros

            // Usuario 10 (Todos los métodos con valores variados)
            ['DESCRIPCION' => 'Compra de equipos tecnológicos', 'MONTO' => 100.00, 'CANTIDAD' => 2, 'USUARIO' => 10, 'METODO_PAGO' => 'QR', 'created_at' => now()->addDays(22), 'CAJA' => 2], // 22 días futuros
            ['DESCRIPCION' => 'Pago de servicios de internet', 'MONTO' => 140.00, 'CANTIDAD' => 1, 'USUARIO' => 10, 'METODO_PAGO' => 'Tarjeta', 'created_at' => now()->addDays(23), 'CAJA' => 2], // 23 días futuros
            ['DESCRIPCION' => 'Pago de salario', 'MONTO' => 120.00, 'CANTIDAD' => 1, 'USUARIO' => 10, 'METODO_PAGO' => 'Efectivo', 'created_at' => now()->addDays(24), 'CAJA' => 1], // 24 días futuros
            ['DESCRIPCION' => 'Compra de herramientas de oficina', 'MONTO' => 115.00, 'CANTIDAD' => 3, 'USUARIO' => 10, 'METODO_PAGO' => 'Transferencia Bancaria', 'created_at' => now()->addDays(25), 'CAJA' => 1], // 25 días futuros
            ['DESCRIPCION' => 'Pago de suscripción anual', 'MONTO' => 130.00, 'CANTIDAD' => 1, 'USUARIO' => 10, 'METODO_PAGO' => 'Stripe', 'created_at' => now()->addDays(26), 'CAJA' => 1], // 26 días futuros
        ]);
        ...
        DB::table('COMPRA')->insert([
            ...
            [
                ...
                'USUARIO' => 2,
                'PROVEEDOR' => 3,
                'created_at' => now()->subDays(1), 'CAJA' => 1
            ],
            // Compra 3
            [
            ...
            [
                ...
                'USUARIO' => 4,
                'PROVEEDOR' => 4,
                'created_at' => now()->subDays(1), 'CAJA' => 2
            ],
            // Compra 5
            [
            ...
            [
                ...
                'USUARIO' => 6,
                'PROVEEDOR' => 2,
                'created_at' => now()->subDays(2),'CAJA' => 2
            ],
            // Compra 7
            [
            ...
            [
                ...
                'USUARIO' => 8,
                'PROVEEDOR' => 4,
                'created_at' => now()->subDays(2),'CAJA' => 3
            ],
            // Compra 9
            [
                ...
                'USUARIO' => 9,
                'PROVEEDOR' => 1,
                'created_at' => now()->subDays(3),'CAJA' => 3
            ],
            // Compra 10
            [
        ...
        DB::table('DETALLE_COMPRA')->insert([
         ...
         DB::table('VENTA')->insert([
            ['TOTAL' => 150.75, 'USUARIO' => 1, 'CLIENTE' => 3, 'ESTADO' => 1, 'METODO_PAGO' => 'QR', 'created_at' => now()->subDays(3), 'CAJA' =>1],
            ['TOTAL' => 230.50, 'USUARIO' => 2, 'CLIENTE' => 4, 'ESTADO' => 1, 'METODO_PAGO' => 'Tarjeta', 'created_at' => now()->subDays(3), 'CAJA' =>1],
            ['TOTAL' => 120.00, 'USUARIO' => 3, 'CLIENTE' => 5, 'ESTADO' => 1, 'METODO_PAGO' => 'Efectivo', 'created_at' => now()->subDays(3), 'CAJA' =>1],
            ['TOTAL' => 450.20, 'USUARIO' => 4, 'CLIENTE' => 6, 'ESTADO' => 1, 'METODO_PAGO' => 'Transferencia Bancaria', 'created_at' => now()->subDays(3), 'CAJA' =>2],
            ['TOTAL' => 75.99, 'USUARIO' => 5, 'CLIENTE' => 7, 'ESTADO' => 1, 'METODO_PAGO' => 'Stripe', 'created_at' => now()->subDays(2), 'CAJA' =>2],
            ['TOTAL' => 200.30, 'USUARIO' => 6, 'CLIENTE' => 8, 'ESTADO' => 1, 'METODO_PAGO' => 'QR', 'created_at' => now()->subDays(2), 'CAJA' =>2],
            ['TOTAL' => 99.99, 'USUARIO' => 7, 'CLIENTE' => 9, 'ESTADO' => 1, 'METODO_PAGO' => 'Tarjeta', 'created_at' => now()->subDays(2), 'CAJA' =>2],
            ['TOTAL' => 380.45, 'USUARIO' => 8, 'CLIENTE' => 10, 'ESTADO' => 1, 'METODO_PAGO' => 'Efectivo', 'created_at' => now()->subDays(2), 'CAJA' =>3],
            ['TOTAL' => 510.00, 'USUARIO' => 9, 'CLIENTE' => 11, 'ESTADO' => 1, 'METODO_PAGO' => 'Transferencia Bancaria', 'created_at' => now()->subDays(1), 'CAJA' =>3],
            ['TOTAL' => 1500.75, 'USUARIO' => 10, 'CLIENTE' => 12, 'ESTADO' => 1, 'METODO_PAGO' => 'Stripe', 'created_at' => now()->subDays(1), 'CAJA' =>3],
            ['TOTAL' => 95.99, 'USUARIO' => 11, 'CLIENTE' => 13, 'ESTADO' => 1, 'METODO_PAGO' => 'QR', 'created_at' => now()->subDays(1), 'CAJA' =>4],
            ['TOTAL' => 870.50, 'USUARIO' => 12, 'CLIENTE' => 14, 'ESTADO' => 1, 'METODO_PAGO' => 'Tarjeta', 'created_at' => now()->subDays(1), 'CAJA' =>4],
            ['TOTAL' => 135.60, 'USUARIO' => 13, 'CLIENTE' => 15, 'ESTADO' => 1, 'METODO_PAGO' => 'Efectivo', 'created_at' => now(), 'CAJA' =>5],
            ['TOTAL' => 220.00, 'USUARIO' => 14, 'CLIENTE' => 16, 'ESTADO' => 1, 'METODO_PAGO' => 'Transferencia Bancaria', 'created_at' => now(), 'CAJA' =>5],
            ['TOTAL' => 310.80, 'USUARIO' => 15, 'CLIENTE' => 13, 'ESTADO' => 1, 'METODO_PAGO' => 'Stripe', 'created_at' => now(), 'CAJA' =>5],
        ]);
